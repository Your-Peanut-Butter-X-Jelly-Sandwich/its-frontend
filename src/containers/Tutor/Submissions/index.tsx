    ...
    },
    {
      ...
      render: (_:any, record:any) => (
        <Link href={`/en/tutor/questions/${qn_id}/submissions/${record.pk}`} passHref>
          <Button style={{ backgroundColor: '#1890ff', color: '#fff', borderColor: '#1890ff' }} type="primary">View Detail</Button>
        </Link>
      ),
    },
  ];
    ...
    <div style={{ padding: 24, backgroundColor: "#fff", minHeight: "100vh" }}>
      <div style={{ marginBottom: '20px' }}>
        <Link href={`/en/tutor/questions/${qn_id}`} passHref>
          <Button style={{ backgroundColor: '#1890ff', color: '#fff', borderColor: '#1890ff' }}>Back to Question Insight</Button>
        </Link>
      </div>
